...
import (
	...
	"greenlight.lennoxmugumira.net/internal/data"
...
/*func (app *application) createMovieHandler(w http.ResponseWriter, r *http.Request) {
	...
	var input struct {
		...
		Runtime data.Runtime `json:"runtime"` // Make this field a data.Runtime type.  catering for getting jso that is customised in this format form the client
